...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/adminPlaceAdd.css">
    <title>WITH</title>
</head>
...
<body>
 <section>
   <form action="/admin/adminPlaceAdd" method="post" id="placeAddForm" enctype="multipart/form-data">
     <div class="admininfo">
         <div class="write">
             <h1 style="text-align: center; margin: 30px 0 30px 0;">장소 등록</h1>
                 ...
                 <div class="container goods_add">
                     <div class="goods_content">
                         ...
                         <div class="goodsbox">
                             ...
                             <input type="text" class="form-control" id="place_detail" name="place_detail">
                         </div>
                         <div class="goodsbox">
                         ...
                         <div class="goodsbox">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="place_zipcode" name="place_zipcode">
                             </div>
                          ...
                          <div class="goodsbox">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="place_adr1" name="place_adr1">
                             </div>
                          ...
                          <div class="goodsbox">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="place_adr2" name="place_adr2">
                             </div>
                         ...
                         <div class="goodsbox">
                             ...
                             <input type="text" class="form-control" id="place_phone" name="place_phone">
                         ...
                         <div class="goodsbox">
                             ...
                             <input type="text" class="form-control" id="place_menu" name="place_menu">
                         ...
                         <div class="goodsbox">
                             ...
                             <input type="text" class="form-control" id="place_bhours" name="place_bhours">
                         ...
                         <div class="goodsbox">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="place_dayoff" name="place_dayoff">
                             </div>
                         ...
                         <div class="goodsbox">
                             ...
                             <div class="input-img">
                                 <input type="text" class="upload-name" id="img_name1" value="이미지를 업로드 하세요" readonly>
                         ...
                         <div class="goodsbox">
                             ...
                             <div class="input-img">
                                 <input type="text" class="upload-name" id="img_name2" value="이미지를 업로드 하세요" readonly>
                         ...
                         <div class="goodsbox">
                             ...
                             <div class="input-img">
                                 <input type="text" class="upload-name" id="img_name3" value="이미지를 업로드 하세요" readonly>
