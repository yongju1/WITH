...
<div class="all">
  <div class="container">
    <form class="postting_con" method="post" action="/board/boardUpload" enctype="multipart/form-data">
      <div class="detail_con"  >
	      ...
	      <label >카테고리: </label>
	       ...
	       <div class="detail">
	       <label>제목</label>
        		<input id="board_title" type="text" name="board_title"></input>
           </div>
          <div class="text_con">
          <label>내용</label>
            <input id="board_content" type="text" name="board_content" style="height:200px; margin-bottom:20px;"></input>
          </div>
          <div class="detail">
              <label class="form-label">메인 이미지</label>
              <div class="input-img">
                  <label for="upload-file">파일선택  </label>
                  <input type="file" id="upload-file" name="upload" style="margin-bottom:20px;"
                  	class="file">
              </div>
          </div>
      ...
      <div class="button_con">
	        <button type="reset" class="post" onclick="location.href='../board/boardList'">취소</button>
